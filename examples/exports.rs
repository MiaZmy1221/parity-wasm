...
use parity_wasm_cp::elements::{Internal, External, Type, FunctionType, Module};
...
fn main() {
	...
	let module = parity_wasm_cp::deserialize_file(&args[1]).expect("File to be deserialized");
